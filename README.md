...
This bot was MADE to be ran on a server, and it is easy to do so. For example, you can use Render to host it, thought it is paid unless you use the Website worker with a few not very legal hacky hacks.
