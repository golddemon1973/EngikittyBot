...
namespace Engikitty.Bot
{
  ...
  public static class EventHandler
  {
    ...
    public static readonly Dictionary<string, SpecialEvent> SpecialEvents = new()
    {
      ...
      {
        ["Once"] = true,
        ["Action"] = async (ApplicationCommandInteraction AppCmdInteraction) =>
        {
          await AppCmdInteraction.SendFollowupMessageAsync(new InteractionMessageProperties()
          {
            ...
            Embeds = [
              new EmbedProperties()
              {
                Thumbnail = new EmbedThumbnailProperties("https://cdn.discordapp.com/attachments/1505301024443994263/1525878485896265840/release.jpg?ex=6a54fc94&is=6a53ab14&hm=4a586739a6960870b68bf1fd6c6a386dfaab8fd0828246adffd7897be702403e&"),
                Title = "Hiiii!!!",
